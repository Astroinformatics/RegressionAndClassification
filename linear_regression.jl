...
md"""
**Question:**  Try changing the initial guess above.  Is the final result sensitive to your initial guess?  How does it affect the number of iterations required to find the minimum?
"""
...
3. **N**ormality. The errors ``\varepsilon_i`` on predictors ``x_i`` are Normally distributed with 0 mean
